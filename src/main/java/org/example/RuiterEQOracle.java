...
public class RuiterEQOracle<A extends UniversalDeterministicAutomaton<?, I, ?, ?, ?> & Output<I, D>, I, D>
        implements EquivalenceOracle<A, I, D> {
    public static class MealyRuiterEQOracle<I, O> extends
            RuiterEQOracle<MealyMachine<?, I, ?, O>, I, Word<O>> implements MealyEquivalenceOracle<I, O> {
        public MealyRuiterEQOracle(int maxDepth, MembershipOracle<I, Word<O>> sulOracle) {
            super(maxDepth, sulOracle);
        }
    }
    private final int maxDepth;
    private final MembershipOracle<I, D> sulOracle;
    public RuiterEQOracle(int maxDepth, MembershipOracle<I, D> sulOracle) {
    ...
    public DefaultQuery<I, D> findCounterExample(A hypothesis, Collection<? extends I> inputs) {
        ...
        for (Word<I> trans : transCover) {
            ...
            output = Objects.requireNonNull(query.getOutput()).toString();
