...
public class Crypto {
    ...
    public static final byte[] HASH_SIGNATURE_ALGORITHM_SHA512RSA = {HASH_ALGORITHM_SHA512, SIGNATURE_ALGORITHM_RSA};
    ...
    public static byte[] SIGN_RSA_SHA512(PrivateKey key, byte[] data) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
